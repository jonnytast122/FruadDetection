...
path = "C:\\Users\\sengo\\Downloads\\Compressed\\Financial_Fraud\\models\\"

with open(path + "xgb_best_model_2.pkl", 'rb') as model_file:
    model = pickle.load(model_file)

with open(path + "label_encoder_2.pkl", 'rb') as encoder_file:
